...
public class iTween : MonoBehaviour
{
	...
	private sealed class _TweenDelay_c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
	{
		internal int _PC;

		internal object _current;

		internal iTween __f__this;
		...
		public bool MoveNext()
		{
			...
			{
			case 0u:
				this.__f__this.delayStarted = Time.time;
				this._current = new WaitForSeconds(this.__f__this.delay);
				this._PC = 1;
				return true;
			case 1u:
				if (this.__f__this.wasPaused)
				{
					this.__f__this.wasPaused = false;
					this.__f__this.TweenStart();
				}
				this._PC = -1;
				break;
			}
	...
	private sealed class _TweenRestart_c__Iterator1 : IEnumerator, IDisposable, IEnumerator<object>
	{
		internal int _PC;
	...
	private sealed class _Start_c__Iterator2 : IEnumerator, IDisposable, IEnumerator<object>
	{
		internal int _PC;
		...
		public bool MoveNext()
		{
			...
			case 0u:
				if (this.__f__this.delay > 0f)
				{
					this._current = this.__f__this.StartCoroutine("TweenDelay");
					this._PC = 1;
					return true;
				}
				break;
	...
	private void GenerateTargets()
	{
		...
		case "color":
		{
			...
			if (text2 != null)
			{
				if (iTween.__f__switch_map2 == null)
				{
					iTween.__f__switch_map2 = new Dictionary<string, int>(1)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.__f__switch_map2.TryGetValue(text2, out num2))
				{
					if (num2 == 0)
					{
		...
		case "audio":
		{
			...
			if (text2 != null)
			{
				if (iTween.__f__switch_map3 == null)
				{
					iTween.__f__switch_map3 = new Dictionary<string, int>(1)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.__f__switch_map3.TryGetValue(text2, out num2))
				{
					if (num2 == 0)
					{
		...
		case "move":
		{
			...
			if (text2 != null)
			{
				if (iTween.__f__switch_map4 == null)
				{
					iTween.__f__switch_map4 = new Dictionary<string, int>(3)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.__f__switch_map4.TryGetValue(text2, out num2))
				{
					if (num2 != 0)
					{
						if (num2 == 1)
		...
		case "look":
		{
			...
			if (text2 != null)
			{
				if (iTween.__f__switch_map9 == null)
				{
					iTween.__f__switch_map9 = new Dictionary<string, int>(1)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.__f__switch_map9.TryGetValue(text2, out num2))
				{
					if (num2 == 0)
					{
	...
	{
		iTween._TweenDelay_c__Iterator0 _TweenDelay_c__Iterator = new iTween._TweenDelay_c__Iterator0();
		_TweenDelay_c__Iterator.__f__this = this;
		return _TweenDelay_c__Iterator;
	}
	...
	{
		iTween._TweenRestart_c__Iterator1 _TweenRestart_c__Iterator = new iTween._TweenRestart_c__Iterator1();
		_TweenRestart_c__Iterator.__f__this = this;
		return _TweenRestart_c__Iterator;
	}
	...
	{
		iTween._Start_c__Iterator2 _Start_c__Iterator = new iTween._Start_c__Iterator2();
	...
	{
		foreach (Hashtable current in iTween.tweens)
		{
